// general code to simplify list opration from internet
 ...
 * @ptr:    	&struct list_head pointer.
 * @type:    	type of the struct this is embedded in.
 * @member:    	name of the list_struct within the struct.
 */
 ...
 * only for internal list manipulation where we know the prev/next entries already!
 */
